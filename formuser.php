        ...
        ?>        
            ...
            <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"><center>FORM USER</center></h1>
                    <p class="mb-4"><center>Berikut adalah data user</p></center><HR>
            ...
            <tr>
                <td>USERNAME</td>
                <td>:</td>
                <td><INPUT TYPE="text" NAME="username" class="card form-control" required></td>
            </tr>
			<tr>
                <td>PASSWORD</td>
                <td>:</td>
                <td><INPUT TYPE="password" NAME="password" class="card form-control" required>
            </tr>
            <tr>
                <td>STATUS</td>
                <td>:</td>
            ...
            <tr>
                ...
                <A HREF="lapuser.php"><CENTER>Lihat Seluruh Data</CENTER><BR><BR><BR></A>
                </td>
            </tr>
            </table></div>
            </form>
...
echo "<script>alert('$nama Berhasil di Simpan');";
