...
<?PHP
	INCLUDE("koneksi.php");
	$nama=$_GET['nama'];
	$query=mysqli_query($koneksi, "select * from tb_user where nama='$nama'");
...
?>
            ...
            <tr>
                <td>nama</td>
                <td>:</td>
                <td><INPUT TYPE="text" NAME="nama" class="card form-control" disabled value="<?PHP echo $row["nama"]; ?>"></td>
            </tr>
          <tr>
                <td>username</td>
                <td>:</td>
                <td><INPUT TYPE="text" NAME="username" class="card form-control" value="<?PHP echo $row["username"]; ?>">
            </tr>
            <tr>
            <tr>
                <td>password</td>
                <td>:</td>
                <td><INPUT TYPE="password" NAME="password" class="card form-control" value="<?PHP echo $row["password"]; ?>">
            </tr>
              <td>STATUS</td>
                <td>:</td>
...
mysqli_query($koneksi, "update tb_user set username='$username', password='$password',status='$status' where nama='$nama'") or die (mysqli_error());
	
echo "<script>alert('User $nama Berhasil di Edit');";
